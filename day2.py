...
print(f'''Once upon a time, there was {age} old coder named {name}.
...
#mutliple lines need 3 quotation marks
#f string interpolation is a way to format strings in python
# What is syntax ? A way of writing code that is correct 
# What is an algorithm? 
#A set of instructions that are followed to solve a problem
# what is a variable? 
#varaible holds data
# What is a string?
# a variable that has quotation marks
